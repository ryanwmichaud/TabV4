...
function solve2(openStrings, ctList, stretch){
...
function solve1(openStrings, ctList, stretch){
...
console.log(sum1/iterations, "brute force valid slns" )
console.log(sum2/iterations, "keep track throughout each recursive call")
console.log( sum3/iterations, "brute force w preprocessing")
console.log( sum4/iterations, "keep track w preprocessing")
